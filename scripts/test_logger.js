...
(async () => {
    try {
        ...
        console.log("Start to listen user vote data usage ------  ")
        ...
        agreementContract.on("UserVote", (userAddress, usageID, dataUsage, consent, event) => {
            ...
            logContract.connect(provider.getSigner(loggerAddress)).log(dataUsage[0], userAddress, usageID, dataUsage[2], dataUsage[4], dataUsage[5]).then((value) => {
                console.log('Log Actual Data Usage tx :', value)
            })
        });
